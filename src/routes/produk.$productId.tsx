        ...
        <div>
          ...
          <div className="mt-4 rounded-xl border border-border bg-card p-4">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              ...
              <button className="h-10 flex-1 rounded-lg bg-primary px-6 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90 sm:flex-none">
                Hubungi Penjual
              </button>
              <button className="h-10 rounded-lg border border-input px-6 text-sm font-semibold text-foreground transition-colors hover:bg-accent">
                Simpan
              </button>
            </div>
          </div>
